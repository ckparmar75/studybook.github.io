...
<!----------------------------div-article----------------------------------------------------------------->
		<div class="col-sm-8" style="background-color: none;">
				...
				<center><h5 style="background-color: #447;margin-top: 10px; color: white;border-radius: 3px;">Quiz</h5></center>

				<article style="padding: 10px; margin: 10px;">
    				<p>All question are mendatory.</p>
    				<p>Each and every question has a one mark</p>
    				<p>Total question is 25 and total marks are 25.</p> 
  				
				<center><button class="btn btn-success" style="width: 100px;">OK</button></center>
				</article>
  		</div>
