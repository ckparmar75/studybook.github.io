...
<!----------------------------div-article----------------------------------------------------------------->
		<div class="col-sm-8" style="background-color: none;">
				...
				<center><h5 style="background-color: #447;color: white;border-radius: 3px;margin-top: 10px;">Recruitment</h5></center>

				<div style="padding: 30px;">
			<div class="row">
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Ojas</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">SSC</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Bank</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">ONGC</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">GPSC</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">UPSC</a></div>
				</div>
			</div>
		</div>
