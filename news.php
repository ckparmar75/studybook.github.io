...
<!----------------------------div-article----------------------------------------------------------------->
		<div class="col-sm-8" style="background-color: none;">
				...
				<center><h5 style="background-color: #447;color: white;border-radius: 3px;margin-top: 10px;">News Paper</h5></center>

		<div style="padding: 30px;">
			<div class="row">
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Gujarat Samachar</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Sandesh</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Divya Bhaskar</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Mumbai Samachar</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">The Hindu</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "#" style="color:#447;text-decoration:none;" class="material-link">Times of India</a></div>
				</div>
			</div>
			<br>
			<center><h5 style="background-color:;color: #447;border-bottom: 1px solid #447;margin-top: 10px;">News Headline</h5></center>
			<article style="margin: 10px;padding: 10px;">
				<p>Today Rajsthan royals vs Mumbai Indian match will start at 07:30 pm onword</p>
			</article>
