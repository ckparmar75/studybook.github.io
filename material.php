...
<!----------------------------div-article----------------------------------------------------------------->
		<div class="col-sm-8" style="background-color: none;">
			<center><h5 style="background-color: #447;color: white;border-radius: 3px;margin-top: 10px;">Material</h5></center>
			<div style="padding: 30px;">
			<div class="row">
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "currentaffairs.php" style="color:#447;text-decoration:none;" class="material-link">Current Affairs</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "historyofgujarat.php" style="color:#447;text-decoration:none;" class="material-link">History of Gujarat</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "historyofindia.php" style="color:#447;text-decoration:none;" class="material-link">History of India</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "worldhistory.php" style="color:#447;text-decoration:none;" class="material-link">History of World</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "sahitya.php" style="color:#447;text-decoration:none;" class="material-link">Gujarati Sahitya</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "gujaratigrammar.php" style="color:#447;text-decoration:none;" class="material-link">Gujarati Grammar</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "mathematic.php" style="color:#447;text-decoration:none;" class="material-link">Mathematics</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "reasoning.php" style="color:#447;text-decoration:none;" class="material-link">Reasoning</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "englishgrammar.php" style="color:#447;text-decoration:none;" class="material-link">English Grammar</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "constitution.php" style="color:#447;text-decoration:none;" class="material-link">Constitution</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "science.php" style="color:#447;text-decoration:none;" class="material-link">Science</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "computer.php" style="color:#447;text-decoration:none;" class="material-link">Computer</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "cultureofgujarat.php" style="color:#447;text-decoration:none;" class="material-link">Culture of Gujarat</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "cultureofindia.php" style="color:#447;text-decoration:none;" class="material-link">Culture of India</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "magazine.php" style="color:#447;text-decoration:none;" class="material-link">Magazine</a></div>
				</div>
				<div class="card" style="background-color: ;color:;width:300px; margin: 20px 20px 20px 70px;padding: 20px;">
				<div class="col-sm-12" ><a href = "question.php" style="color:#447;text-decoration:none;" class="material-link">Question</a></div>
				</div>
